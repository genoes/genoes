...
- 📚 Certified [Software Carpentries](https://carpentries.org/) Instructor
  ...
  - Workshops led:
    ...
    - <img src="https://bashlogo.com/img/symbol/svg/full_colored_dark.svg" alt="bash" width="20" height="20"/> Bash
    - <img src="https://www.vectorlogo.zone/logos/jupyter/jupyter-icon.svg" alt="jupyter" width="20" height="20"/> Jupyter Notebooks/Jupyter Lab
